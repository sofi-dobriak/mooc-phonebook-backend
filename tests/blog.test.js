...
const listHelpers = require('../utils/blogsHelpers');
...
describe('most blogs', () => {
  ...
  test('blog list with one object', () => {
    const blogsOne = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
    ...
    const result = listHelpers.mostBlogs(blogsOne);
    assert.deepStrictEqual(result, { author: 'Michael Chan', blogs: 1 });
  });

  test('blog list with many objects', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
